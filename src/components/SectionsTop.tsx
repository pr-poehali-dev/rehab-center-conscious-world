...
const HERO_IMAGE =
  "https://cdn.poehali.dev/projects/184f0e0d-a684-434f-8d45-5000ddbe56df/files/d152e661-1e44-4189-8c8d-fcf36b52b105.jpg";
const ABOUT_IMAGE =
  "https://cdn.poehali.dev/projects/184f0e0d-a684-434f-8d45-5000ddbe56df/files/49310e31-d9fe-48b0-a186-15f67e0156ff.jpg";

const SERVICES = [
  {
    icon: "Brain",
    title: "Психотерапия",
    desc: "Индивидуальная работа с опытным психотерапевтом. Проработка травм, тревоги, депрессии.",
  },
  {
    icon: "Heart",
    title: "Реабилитация",
    desc: "Комплексные программы восстановления после зависимостей и психологических кризисов.",
  },
  {
    icon: "Users",
    title: "Групповая терапия",
    desc: "Поддерживающие группы под руководством специалиста. Безопасное пространство для роста.",
  },
  {
    icon: "Leaf",
    title: "Телесные практики",
    desc: "Йога, дыхательные техники и соматическая терапия для восстановления связи с телом.",
  },
  {
    icon: "Palette",
    title: "Арт-терапия",
    desc: "Творческое самовыражение как путь к осознанности и внутренней гармонии.",
  },
  {
    icon: "Shield",
    title: "Семейная терапия",
    desc: "Восстановление отношений в семье, улучшение коммуникации и взаимопонимания.",
  },
];
...
export default function SectionsTop({
  ...
  return (
    <>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 right-0 w-1/2 h-full">
            <img
              ...
              style={{
                maskImage:
                  "linear-gradient(to left, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0) 100%)",
                WebkitMaskImage:
                  "linear-gradient(to left, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0) 100%)",
              }}
            />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, hsl(158 28% 60%) 0%, transparent 70%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, hsl(35 45% 70%) 0%, transparent 70%)",
            }}
          />
        </div>
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex items-center gap-10 mt-12 animate-fade-in-up delay-400">
              {[
                ...
                <div key={l}>
                  <p className="font-display text-3xl text-deep-slate font-medium">
                    {n}
                  </p>
      ...
      <section
        id="about"
        className="section-padding bg-white flower-of-life-bg"
      >
        <div className="container-max">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="font-body text-sage text-sm uppercase tracking-[0.2em] mb-3">
                О центре
              </p>
              ...
              <p className="font-body text-muted-foreground leading-relaxed mb-5">
                С 2012 года мы помогаем людям обрести устойчивость и вернуться к
                полноценной жизни. Наш центр — это не просто клиника, это место,
                где каждый человек встречает понимание, уважение и
                профессиональную поддержку.
              </p>
              <p className="font-body text-muted-foreground leading-relaxed mb-8">
                Мы работаем с зависимостями, психологическими травмами,
                тревожными расстройствами и другими состояниями, которые мешают
                жить в полную силу. Наш подход — доказательный, гуманный и
                индивидуальный.
              </p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: "Award", text: "Лицензия Минздрава" },
                  { icon: "Users", text: "более 1000 специалистов" },
                  ...
                  <div key={text} className="flex items-center gap-3">
                    ...
                    <span className="font-body text-sm text-deep-slate">
                      {text}
                    </span>
                  </div>
                ))}
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-lg border border-border max-w-xs">
                <p className="font-display text-4xl text-sage font-medium">
                  98%
                </p>
                <p className="font-body text-sm text-muted-foreground mt-1">
                  пациентов отмечают значительное улучшение состояния
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        id="services"
        className="section-padding bg-warm-cream flower-of-life-bg"
      >
        <div className="container-max">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((s) => (
              ...
              >
                ...
                <h3 className="font-display text-2xl text-deep-slate mb-3">
                  {s.title}
                </h3>
        ...
        <div className="container-max">
          <div className="text-center mb-14">
            ...
            <p className="font-body text-muted-foreground mt-4 max-w-xl mx-auto">
              Каждая программа разработана с учётом индивидуальных потребностей.
              Мы поможем выбрать подходящий формат.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {PROGRAMS.map((p) => (
              <div
                key={p.title}
                className={`${p.color} rounded-3xl p-8 flex flex-col border border-border card-hover`}
              >
                ...
                <h3 className="font-display text-3xl text-deep-slate mb-4">
                  {p.title}
                </h3>
            ...
            <Button
              onClick={() =>
                onPayment({
                  ...
                  amount: 2000,
                  description: "30 минут со специалистом",
                })
              }
